...
export async function GET() {
  ...
  const [members,books,monthlyReadings,currentReading,ownStatuses,allStatuses,comments,activities,messages]=await Promise.all([
  ...
  return NextResponse.json({club:{...club,currentBook:currentReading?.books[0]?.book||null},members,books,statuses,allStatuses,monthlyReadings,user,profileStats,ownStatuses,readerRanking,bookRanking,readingReport,comments,activities,messages});
}
